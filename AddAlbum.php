 ...
 <div>
	...
	<form  method="post" action="modify.php" enctype="multipart/form-data">
		...
		<div class="input-group">
                        ...
                        <input type="text" name="Name" size="100" autocomplete="off" placeholder="Album Name">
		</div>
		                <button type="submit" name="submit" value="submit" class="btn " style="font-family: sans-serif;width: 100%"  >Add Album</button>               
        </form>
        </div>
    </div>    
 </body>
