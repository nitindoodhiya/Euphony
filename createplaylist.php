...
<body >
 <div>
	...
	<form  method="post" action="playlist.php" enctype="multipart/form-data">
                ...
                <div class="header">
                        <h2> Enter Playlist Details </h2>
                </div>
		<div class="input-group">
			
                        <input type="text" name="Name" size="100" autocomplete="off" placeholder="Playlist Name">
		</div>
		                <button type="submit" name="submit" value="submit" class="btn " style="font-family: sans-serif;width: 100%"  >Add Playlist</button>               
        </form>
        </div>
    </div>    
 </body>
