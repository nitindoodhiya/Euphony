...
<div id="home">
            ...
            t +=' <thead><tr><th ><h4 style="color: white">Title</h4></th>           <th ><h4 style="color: white">Artists</h4></th><th ><h4 style="color: white">Rename</h4></th>    </tr>  <tbody style="font:1.5em Sans-serif">';   
                ...
                {t += '<tr id="playlist">';
                    if(i==0){
                        ...
                        t +='<td> <!-- Material unchecked --><div class="form-check"><input type="checkbox" class="form-check-input" id="materialUnchecked"></div></td>';
                        t += '</tr>';
                    }
                    else{
  ...
  <button type="button" class="btn btn-primary" style="max-width:5pc">Primary</button>
</div>
